...
class MMysql {
    ...
    protected function _connect() {
        ...
        try {
            ...
            die('Connection failed123: ' . $e->getMessage());
        }
 ...
 * @return $this
 */
function GetTableValue($table,$field,$filter){
    global $mysql;
 ...
 * @return $this
 */
function GetTableColumn($table,$field,$filter){
    global $mysql;
    $sql = "select {$field} from {$table} where {$filter}";
    $column = $mysql->doSql($sql);
