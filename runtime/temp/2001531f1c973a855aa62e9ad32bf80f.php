<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"/var/www/sea/application/sea/view/page/login.html";i:1523613308;s:43:"/var/www/sea/application/sea/view/base.html";i:1522331186;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>登录 | HaI management center</title>
    <!-- Favicons-->
...
<div id="login-page" class="row">
  <div class="col s12 z-depth-4 card-panel">
    <form class="login-form" action="/dologin" method="post" onsubmit="verify()">
      <div class="row">
        <div class="input-field col s12 center">
          <img src="__STATIC__/images/resizeApi.png" alt="" class="circle responsive-img valign profile-image-login">
          <p class="center login-form-text">HaI 管理中心</p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="input-field col s12">
          <button class="btn col s12" type="submit">登录</button>
        </div>
      </div>
      <div class="row">
