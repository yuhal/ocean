<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"/var/www/sea/application/sea/view/page/forgotpassword.html";i:1523612781;s:43:"/var/www/sea/application/sea/view/base.html";i:1522331186;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>忘记密码 | HaI management center</title>
    <!-- Favicons-->
    ...
    <form class="login-form" action="/savepassword" method="post" onsubmit="verify()">
      <div class="row">
        <div class="input-field col s12 center">
          <p class="center login-form-text">忘记密码</p>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="input-field col s6 m6 l6">
          <p class="margin right-align medium-small"><a href="login">去登录</a></p>
        </div>
      </div>
    </form>
  </div>
